...
**Test:** EditMode 34/34 PASS (authored-edge geçişinde DrawPartNeighborGraphTests de silindi → 44'ten 34'e; kalan: EdgeFill/DrawEdge/GameState/GameServices/PlayerHealth/EventChannel). EdgeNetwork/WinCondition/RailPaintController/CoinHud için EditMode test yok — MonoBehaviour/scene-bağımlı, hepsi Play'de doğrulandı (4 level edge + win + lose + restart + coins).
